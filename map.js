...
var ndvi = new ol.layer.Image({
  ...
  source: new ol.source.ImageWMS({
    url: "http://localhost:8081/geoserver/wms", //This url points to the
    // geoserver mosaic storage. <Replace this with the url to your geoserver mosaic url>
    params: {
      LAYERS: "NDVI:timeseries_data_punjab",
      time: "2021-06-10",
    },
    ratio: 1,
...
sliderRange.oninput = function () {
  ...
  overlays
    ...
    .item(0)
    .getSource()
    .updateParams({ TIME: dates[this.value] });
  i = this.value;
  //console.log(i);
};
...
function play() {
  ...
  function run() {
    ...
    if (i < 22) {
      //  if the counter < 22, call the loop function
